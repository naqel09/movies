...
// import video from '../assets/IronManTrailer.mp4'
    ...
    return (
        <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
            ...
            <div className='relative mt-6'>
                ...
                <video controls autoPlay width="960" height="540" poster={currentTrailer.image} className='mx-auto max-w-full'>
                    <source src={currentTrailer.videoUrl} controls={false} type='video/mp4'/>
                </video>
